...
generate_field_type_enum!(
    Integer => libparsec_types_lite::Integer,
    Float => libparsec_types_lite::Float,
    Version => libparsec_types_lite::VersionInt,
    Size => libparsec_types_lite::SizeInt,
    Index => libparsec_types_lite::IndexInt,
    ...
    BlockID => libparsec_types_lite::BlockID,
    DeviceID => libparsec_types::DeviceID,
    OrganizationID => libparsec_types_lite::OrganizationID,
    UserID => libparsec_types::UserID,
    VlobID => libparsec_types_lite::VlobID,
    PKIEnrollmentID => libparsec_types_lite::PKIEnrollmentID,
    AsyncEnrollmentID => libparsec_types_lite::AsyncEnrollmentID,
    SequesterServiceID => libparsec_types_lite::SequesterServiceID,
    AccountAuthMethodID => libparsec_types_lite::AccountAuthMethodID,
    AccountVaultItemOpaqueKeyID => libparsec_types_lite::AccountVaultItemOpaqueKeyID,
    TOTPOpaqueKeyID => libparsec_types_lite::TOTPOpaqueKeyID,
    DeviceLabel => libparsec_types::DeviceLabel,
    HumanHandle => libparsec_types::HumanHandle,
    EmailAddress => libparsec_types::EmailAddress,
    UserProfile => libparsec_types_lite::UserProfile,
    ...
    GreetingAttemptID => libparsec_types_lite::GreetingAttemptID,
