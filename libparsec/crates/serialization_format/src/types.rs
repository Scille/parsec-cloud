...
generate_field_type_enum!(
    ...
    BlockID => libparsec_serialization_format_types::BlockID,
    DeviceID => libparsec_types::DeviceID,
    OrganizationID => libparsec_serialization_format_types::OrganizationID,
    UserID => libparsec_types::UserID,
    VlobID => libparsec_serialization_format_types::VlobID,
    PKIEnrollmentID => libparsec_serialization_format_types::PKIEnrollmentID,
    AsyncEnrollmentID => libparsec_serialization_format_types::AsyncEnrollmentID,
    SequesterServiceID => libparsec_serialization_format_types::SequesterServiceID,
    AccountAuthMethodID => libparsec_serialization_format_types::AccountAuthMethodID,
    AccountVaultItemOpaqueKeyID => libparsec_serialization_format_types::AccountVaultItemOpaqueKeyID,
    TOTPOpaqueKeyID => libparsec_serialization_format_types::TOTPOpaqueKeyID,
    DeviceLabel => libparsec_types::DeviceLabel,
    HumanHandle => libparsec_types::HumanHandle,
    EmailAddress => libparsec_types::EmailAddress,
    UserProfile => libparsec_serialization_format_types::UserProfile,
    RealmRole => libparsec_types::RealmRole,
    AccessToken => libparsec_types::AccessToken,
    ...
    GreetingAttemptID => libparsec_serialization_format_types::GreetingAttemptID,
    ...
    ParsecAddr => libparsec_types::ParsecAddr,
    // Used only in shamir
