...
fn quote_type_as_fn_getter_conversion(field_path: &TokenStream, ty: &FieldType) -> TokenStream {
    ...
    match ty {
        ...
        FieldType::AccountDeletionToken => {
            quote_rs_to_py_class!(crate::token::AccountDeletionToken)
        }
...
fn quote_type_as_fn_new_param(ty: &FieldType) -> TokenStream {
    match ty {
        ...
        FieldType::AccountDeletionToken => quote! { crate::token::AccountDeletionToken },
