...
pub enum AccountCreateWebLocalDeviceKeyError {
...
pub(super) async fn account_create_web_local_device_key(
    account: &Account,
    ...
    let vault_key = {
        ...
        .map_err(AccountCreateWebLocalDeviceKeyError::BadVaultKeyAccess)?;
        access.vault_key
    };
...
#[cfg(test)]
#[path = "../tests/unit/create_web_local_device_key.rs"]
mod tests;
