    ...
    mount_and_test!(as "bob@dev1", &env, &tmp_path, |_client: Arc<Client>, _wksp1_ops: Arc<WorkspaceOps>, mountpoint_path: PathBuf| async move {
        ...
        if should_succeed {
            ...
            p_assert_eq!(
                err.raw_os_error(),
                Some(match kind {
                    "create_append" | "create_new_write" => windows_sys::Win32::Foundation::ERROR_WRITE_PROTECT as i32,
                    ...
                    "open_for_read" | "open_for_write" | "open_for_write_truncate" | "open_for_append" | "open_for_read_write" => windows_sys::Win32::Foundation::ERROR_ACCESS_DENIED as i32,
                    unknown => panic!("Unknown kind: {}", unknown),
                }),
                "{}",
                err
