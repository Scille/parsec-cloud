...
use libparsec_client_certif::*;
use libparsec_client_common::config::*;
use libparsec_client_common::event_bus::*;
use libparsec_client_connection::AuthenticatedCmds;
use libparsec_platform_async::lock::Mutex as AsyncMutex;
use libparsec_types::prelude::*;

use crate::{certif::CertificateOps, ClientConfig, EventBus};
...
impl WorkspaceOps {
    ...
    pub fn update_workspace_external_info(&self, updater: impl FnOnce(&mut WorkspaceExternalInfo)) {
        let mut guard = self
