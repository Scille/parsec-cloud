...
fn serde_user_certificate_legacy_format(alice: &Device, bob: &Device) {
    ...
    let data_is_admin_true = hex!(
        "f1328bb29b9c55ed016bcb89756fd8b7733996637e0a1b7e2175d2c56dd1b7e65f319c"
        "b8e7e0c19b795d52185e86f87c938de5f564907d6ab0d960cff02a9e08789c6b5b5252"
        "5990baa1b438b5283e39b5a824332d3339b1247559626949467ed1aac49ccce4548794"
        "d432c3952599b9a9c52589b905d7191d6f645d6d391b1bbc1cac2d336571527ed2aa82"
        "d224a0e2f8ecd4ca230a3533e7cd6cd8f7b99c9dad9bfd6669a4dc9f30e3e897c93eef"
        "be9f345a30a7534e754566717c624a6e66de6100a6953b01"
    );
    // Generated from Python implementation (Parsec v2.6.0)
    // Content:
    //   type: "user_certificate"
    ...
    let data_is_admin_false = hex!(
        "15dd73f6ddd5af3b46806437194083c80921d51029393b21cb3da620dc42ec7056625b"
        "5b5dae3d16f822a505d609581979c62d093827fd418cc0d0cd99039707789c6b5b5252"
        "5990baa1b438b5283e39b5a824332d3339b1247559626949467ed1aac49ccce4548794"
        "d432c3952599b9a9c52589b905d7191d6f645d6d391b1bbc1cac2d336571527ed2aa82"
        "d224a0e2f8ecd4ca230a3533e7cd6cd8f7b99c9dad9bfd6669a4dc9f30e3e897c93eef"
        "be9f345a30a7534e754566717c624a6e66de2100a6943b00"
    );
...
fn serde_device_certificate_legacy_format(alice: &Device, bob: &Device) {
    ...
    //   verify_key: <bob.verify_key>
    let data = hex!(
        "7068b77b57567dff9c201f0897f3020076420019884651f7fe604b364f88496dee3674"
        "294b02a645d65b0b055add67403235038230045c98df01b0d17080cb00789c6b5d5252"
        "5990ba2925b52c3339353e39b5a824332d3339b1247559626949467ed1aac41ca08403"
        "50de706549666e6a7149626ec17546c71b59575bcec606af846acc4c5991949f0456b6"
        "aa2cb52833ad323e3bb5f288420b6fbbbe53d02d5d99f98dcb6bb77e58ba731b57cc3d"
        "b957fb1d2cfabeed59e6c90900151e3980"
    );
    let data = Bytes::from(data.as_ref().to_vec());
