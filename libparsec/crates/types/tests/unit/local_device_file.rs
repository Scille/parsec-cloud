...
fn smartcard_device_file(alice: &Device) {
    ...
    //   device_label: 'My dev1 machine'
    //   certificate_ref: { id: 0x666f6f, hash: 'sha256-AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=', }
    ...
    let raw: &[u8] = hex!(
        ...
        "6d616368696e65af63657274696669636174655f72656682a26964c403666f6fa46861"
        "7368d9337368613235362d414141414141414141414141414141414141414141414141"
        "414141414141414141414141414141414141413dbb616c676f726974686d5f666f725f"
        "656e637279707465645f6b6579b152534145532d4f4145502d534841323536ad656e63"
        "7279707465645f6b6579c403666f6faa63697068657274657874c50211a73aff77a2aa"
    ...
    let expected = DeviceFile::Smartcard(DeviceFileSmartcard {
        ...
        certificate_ref: X509CertificateReference {
            id: Some(Bytes::from_static(b"foo")),
