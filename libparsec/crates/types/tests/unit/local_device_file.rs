...
fn smartcard_device_file(alice: &Device) {
    ...
    //   device_label: 'My dev1 machine'
    //   certificate_ref: { uri: 0x666f6f, hash: 'sha256-AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=', }
    ...
    let raw: &[u8] = hex!(
        ...
        "6d616368696e65af63657274696669636174655f72656682a3757269c403666f6fa468"
        ...
        "637279707465645f6b6579c403666f6faa63697068657274657874c50211a73aff77a2"
        "aa692b4393e094bfd2c2ccad4b0a8d010960caf27165b787fb412ed2aeeb99f492a870"
        "63e368cebe38dc1f20c65273cb3254480cc9e4b519a53241205b531b41edfa749419b8"
        "3aeb0fb46cc2e21ae25782a1ab8fd3a32ca3b8fca4a0ffc8a301b62aca6612d87e7f34"
        "a89b6e747ec82d38734d7943e17009d091d699871aaf964b8426292d0a405ea3e868dc"
        "a65028dae317a0311af3a958f86541edaef33d49e05056ccb038cc9f7dae40a336dd20"
        "7eea4341229ba7efa39aa0df28d0d33d91fba49dd63f3814c162fff9083674acd6cc8b"
        "621b869c801d0a527474e7da6cd51053803529542d39c9e6794353be278c39ec06cb20"
        "560a01e80db86a20df80808f2115ff28afdc2cf9da5099218d4c873dfcbf78e88e4e63"
        "ddfcf883de5527b4b234ca63c286a7aa12de2fc6337dd1709f6f5922e3d9f1029ce2b6"
        "6d2fb856edb1c701f32c33fa4ca5d0789f52ce2091c48270324f5f631000f6ded1f0c5"
        "e1ae94831f488faeff93d8e0c2e26411b499dea920a14733fbea42dd95a8ec13726f33"
        "c45f0c19f6e6b9b37adde46ce49465ebad63bfd8106e2d1fb7bc2ff3fea5c86d713226"
        "e098aca0ea48fe4180e801eac583e96fd9fae329358f54f57d46c22f845e3d083f6d6d"
        "eaf09d821eaaadbbd945ac6f8131b70427794db0dedba44fcb6224654859605a2bbeb9"
        "79e7d73f233724ab4846b38c94ce603de796f866d0d90fb0badd037a135cca4d018e"
    )
    .as_ref();
    let expected = DeviceFile::Smartcard(DeviceFileSmartcard {
        ...
        certificate_ref: X509CertificateReference::from(X509CertificateHash::fake_sha256())
            .add_or_replace_uri(Bytes::from_static(b"foo")),
