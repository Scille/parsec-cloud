...
use crate::{
    ...
    Duration, RealmID, HumanHandle, LocalDevice, OrganizationID, TimeProvider, UserCertificate,
    UserID, UserProfile,
};
...
pub fn alice(coolorg: &Organization) -> Device {
    Device {
        ...
        user_realm_id: RealmID::from_hex("a4031e8bcdd84df8ae12bd3d05e6e20f").unwrap(),
...
pub fn bob(coolorg: &Organization) -> Device {
    Device {
        ...
        user_realm_id: RealmID::from_hex("71568d41afcb4e2380b3d164ace4fb85").unwrap(),
        user_realm_key: SecretKey::from(hex!(
