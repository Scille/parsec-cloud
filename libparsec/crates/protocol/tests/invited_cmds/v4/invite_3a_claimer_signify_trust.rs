...
pub fn req() {
    ...
    let invited_cmds::AnyCmdReq::Invite3aClaimerSignifyTrust(req2) = data else {
        unreachable!()
    };
...
pub fn rep_ok() {
    ...
    let expected = invited_cmds::invite_3a_claimer_signify_trust::Rep::Ok;
...
pub fn rep_already_deleted() {
    ...
    let expected = invited_cmds::invite_3a_claimer_signify_trust::Rep::AlreadyDeleted;
...
pub fn rep_not_found() {
    ...
    let expected = invited_cmds::invite_3a_claimer_signify_trust::Rep::NotFound;
...
pub fn rep_invalid_state() {
    ...
    let expected = invited_cmds::invite_3a_claimer_signify_trust::Rep::InvalidState;
