...
pub fn rep_already_deleted() {
    ...
    let expected = invited_cmds::invite_2a_claimer_send_hashed_nonce::Rep::AlreadyDeleted;
...
pub fn rep_not_found() {
    ...
    let expected = invited_cmds::invite_2a_claimer_send_hashed_nonce::Rep::NotFound;
...
pub fn rep_invalid_state() {
    ...
    let expected = invited_cmds::invite_2a_claimer_send_hashed_nonce::Rep::InvalidState;
