...
pub fn rep_ok() {
    let raw_expected = [
        (
            ...
            //   revoked: [ ]
            hex!(
                "83a6737461747573a26f6ba661637469766590a77265766f6b656490"
            ).as_ref(),
            ...
            authenticated_account_cmds::organization_self_list::Rep::Ok {
                active: vec![
                    authenticated_account_cmds::organization_self_list::ActiveUser {
                        ...
                        organization_config: authenticated_account_cmds::organization_self_list::OrganizationConfig {
                            is_expired: false,
                            user_profile_outsider_allowed: true,
                            active_users_limit: ActiveUsersLimit::NoLimit,
                            allowed_client_agent: authenticated_account_cmds::organization_self_list::AllowedClientAgent::NativeOrWeb,
                            account_vault_strategy: authenticated_account_cmds::organization_self_list::AccountVaultStrategy::Allowed,
                        },
                    },
                    authenticated_account_cmds::organization_self_list::ActiveUser {
                        ...
                        organization_config: authenticated_account_cmds::organization_self_list::OrganizationConfig {
                            ...
                            allowed_client_agent: authenticated_account_cmds::organization_self_list::AllowedClientAgent::NativeOnly,
                            account_vault_strategy: authenticated_account_cmds::organization_self_list::AccountVaultStrategy::Forbidden,
                        },
                    },
                ],
                revoked: vec![
