...
pub fn req() {
    ...
    let authenticated_cmds::AnyCmdReq::VlobMaintenanceSaveReencryptionBatch(req2) = data else {
        unreachable!()
    };
...
pub fn rep_ok() {
    ...
    //   status: "ok"
    //   total: 8
    let raw = hex!("83a4646f6e6508a6737461747573a26f6ba5746f74616c08");
...
pub fn rep_not_allowed() {
    ...
    let expected = authenticated_cmds::vlob_maintenance_save_reencryption_batch::Rep::NotAllowed;
...
pub fn rep_not_found() {
    ...
    let expected = authenticated_cmds::vlob_maintenance_save_reencryption_batch::Rep::NotFound {
