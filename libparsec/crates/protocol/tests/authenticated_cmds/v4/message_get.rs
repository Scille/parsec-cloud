...
pub fn rep_ok() {
    // Generated from Python implementation (Parsec v2.16.0+dev)
    // Content:
    //   messages: [
    //     {
    //       index: 1
    //       certificate_index: 0
    //       timestamp: 2000-1-2T01:00:00Z
    //       body: b"foobar"
    //       count: 1
    //       sender: "alice@dev1"
    //     }
    ...
    //   status: "ok"
    let raw = hex!(
        "82a6737461747573a26f6ba86d657373616765739185a4626f6479c406666f6f626172b163"
        "657274696669636174655f696e64657800a5696e64657801a673656e646572aa616c696365"
        "4064657631a974696d657374616d70d70141cc375188000000"
    );
