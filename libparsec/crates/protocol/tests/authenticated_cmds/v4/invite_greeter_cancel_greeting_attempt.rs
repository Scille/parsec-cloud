...
pub fn rep_author_not_allowed() {
    ...
    let expected = authenticated_cmds::invite_greeter_cancel_greeting_attempt::InviteGreeterCancelGreetingAttemptRep::AuthorNotAllowed;
    println!("***expected: {:?}", expected.dump().unwrap());
    let data = authenticated_cmds::invite_greeter_cancel_greeting_attempt::Rep::load(raw).unwrap();
...
pub fn rep_invitation_cancelled() {
    ...
    let expected = authenticated_cmds::invite_greeter_cancel_greeting_attempt::InviteGreeterCancelGreetingAttemptRep::InvitationCancelled;
    println!("***expected: {:?}", expected.dump().unwrap());
    let data = authenticated_cmds::invite_greeter_cancel_greeting_attempt::Rep::load(raw).unwrap();
    p_assert_eq!(data, expected);
}
...
pub fn rep_invitation_completed() {
    ...
    let expected = authenticated_cmds::invite_greeter_cancel_greeting_attempt::InviteGreeterCancelGreetingAttemptRep::InvitationCompleted;
    println!("***expected: {:?}", expected.dump().unwrap());
    let data = authenticated_cmds::invite_greeter_cancel_greeting_attempt::Rep::load(raw).unwrap();
    p_assert_eq!(data, expected);
}
...
pub fn rep_greeting_attempt_not_found() {
    ...
    let expected = authenticated_cmds::invite_greeter_cancel_greeting_attempt::InviteGreeterCancelGreetingAttemptRep::GreetingAttemptNotFound;
    println!("***expected: {:?}", expected.dump().unwrap());
    let data = authenticated_cmds::invite_greeter_cancel_greeting_attempt::Rep::load(raw).unwrap();
    p_assert_eq!(data, expected);
}
...
pub fn rep_greeting_attempt_not_joined() {
    ...
    .as_ref();
    let expected = authenticated_cmds::invite_greeter_cancel_greeting_attempt::InviteGreeterCancelGreetingAttemptRep::GreetingAttemptNotJoined;
    println!("***expected: {:?}", expected.dump().unwrap());
    let data = authenticated_cmds::invite_greeter_cancel_greeting_attempt::Rep::load(raw).unwrap();
    p_assert_eq!(data, expected);
}
...
pub fn rep_greeting_attempt_already_cancelled() {
    ...
    let expected = authenticated_cmds::invite_greeter_cancel_greeting_attempt::InviteGreeterCancelGreetingAttemptRep::GreetingAttemptAlreadyCancelled {
...
pub fn rep_ok() {
    ...
    .as_ref();
    let expected = authenticated_cmds::invite_greeter_cancel_greeting_attempt::InviteGreeterCancelGreetingAttemptRep::Ok;
    println!("***expected: {:?}", expected.dump().unwrap());
    let data = authenticated_cmds::invite_greeter_cancel_greeting_attempt::Rep::load(raw).unwrap();
    p_assert_eq!(data, expected);
}
pub fn req() {
    ...
    //   reason: 'MANUALLY_CANCELLED'
    let raw: &[u8] = hex!(
    "83a3636d64d926696e766974655f677265657465725f63616e63656c5f677265657469"
    ...
    .as_ref();
    let req = authenticated_cmds::invite_greeter_cancel_greeting_attempt::InviteGreeterCancelGreetingAttemptReq {
        greeting_attempt: GreetingAttemptID::from_hex("d864b93ded264aae9ae583fd3d40c45a").unwrap(),
        reason: CancelledGreetingAttemptReason::ManuallyCancelled,
    };
    println!("***expected: {:?}", req.dump().unwrap());

    let expected = authenticated_cmds::AnyCmdReq::InviteGreeterCancelGreetingAttempt(req);
