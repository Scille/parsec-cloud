...
pub fn rep_invitation_not_found() {
    ...
    let expected = authenticated_cmds::invite_3a_greeter_wait_peer_trust::Rep::InvitationNotFound;
...
pub fn rep_invitation_deleted() {
    ...
    let expected = authenticated_cmds::invite_3a_greeter_wait_peer_trust::Rep::InvitationDeleted;
...
pub fn rep_enrollment_wrong_state() {
    ...
    let expected = authenticated_cmds::invite_3a_greeter_wait_peer_trust::Rep::EnrollmentWrongState;
