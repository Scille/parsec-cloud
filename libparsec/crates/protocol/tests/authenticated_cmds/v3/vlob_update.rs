...
pub fn req() {
    let raw_expected = [
        (
            ...
            authenticated_cmds::AnyCmdReq::VlobUpdate(authenticated_cmds::vlob_update::Req {
                encryption_revision: 8,
        ...
        (
            ...
            authenticated_cmds::AnyCmdReq::VlobUpdate(authenticated_cmds::vlob_update::Req {
                ...
                version: 8,
                blob: b"foobar".as_ref().into(),
                sequester_blob: Maybe::Present(Some(HashMap::from([(
...
pub fn rep_not_allowed() {
    ...
    let expected = authenticated_cmds::vlob_update::Rep::NotAllowed;
...
pub fn rep_not_found() {
    ...
    let expected = authenticated_cmds::vlob_update::Rep::NotFound {
...
pub fn rep_bad_version() {
    ...
    let expected = authenticated_cmds::vlob_update::Rep::BadVersion;
...
pub fn rep_bad_encryption_revision() {
    ...
    let expected = authenticated_cmds::vlob_update::Rep::BadEncryptionRevision;
...
pub fn rep_in_maintenance() {
    ...
    let expected = authenticated_cmds::vlob_update::Rep::InMaintenance;
...
pub fn rep_bad_timestamp() {
    ...
    let err = authenticated_cmds::vlob_update::Rep::load(&raw).unwrap_err();
    ...
    let expected = authenticated_cmds::vlob_update::Rep::BadTimestamp {
        reason: None,
...
pub fn rep_not_a_sequestered_organization() {
    ...
    let expected = authenticated_cmds::vlob_update::Rep::NotASequesteredOrganization;
...
pub fn rep_timeout() {
    ...
    let expected = authenticated_cmds::vlob_update::Rep::Timeout;
