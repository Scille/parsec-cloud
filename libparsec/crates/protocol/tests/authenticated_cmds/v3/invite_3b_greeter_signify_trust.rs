...
pub fn rep_not_found() {
    ...
    let expected = authenticated_cmds::invite_3b_greeter_signify_trust::Rep::NotFound;
...
pub fn rep_already_deleted() {
    ...
    let expected = authenticated_cmds::invite_3b_greeter_signify_trust::Rep::AlreadyDeleted;
...
pub fn rep_invalid_state() {
    ...
    let expected = authenticated_cmds::invite_3b_greeter_signify_trust::Rep::InvalidState;
