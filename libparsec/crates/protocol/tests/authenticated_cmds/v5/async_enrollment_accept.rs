    ...
    for (raw, req) in [
        (
            ...
            hex!(
                ...
                "5f6465766963655f63657274696669636174653ea77061796c6f6164c4de0028b52ffd"
                "0058a50600340c87a474797065bf6173796e635f656e726f6c6c6d656e745f61636365"
                "70745f7061796c6f6164a7757365725f6964d802a11cec001000a9646576696365de10"
                "ac6c6162656caf4d792064657631206d616368696e65ac68756d616e5f68616e646c65"
                "92b1616c696365406578616d706c652e636f6db2416c69636579204d6346616365a770"
                "726f66696c65a541444d494eaf726f6f745f7665726966795f6b6579c420be2976732c"
                "ec8ca94eedcf0aafd413cd159363e0fadc9e68572c77a1e17d9bbd0500cf22e067c682"
                "92eda7d8b60128b17061796c6f61645f7369676e617475726585a474797065a3504b49"
                "bd61636365707465725f6465725f783530395f6365727469666963617465c41b3c6163"
                "63657074657220783530392063657274696669636174653ea9616c676f726974686db1"
            ...
            authenticated_cmds::async_enrollment_accept::Req {
                ...
                payload_signature: authenticated_cmds::async_enrollment_accept::PayloadSignature::PKI {
        ...
        (
            ...
            //   payload_signature: {
            //     type: 'OPEN_BAO',
            //     accepter_openbao_entity_alias_id: 'e7d07e2a-b05d-ec59-dcf2-4403efdbf1b7',
            ...
            hex!(
                ...
                "726f66696c65a541444d494eaf726f6f745f7665726966795f6b6579c420be2976732c"
                "ec8ca94eedcf0aafd413cd159363e0fadc9e68572c77a1e17d9bbd0500cf22e067c682"
                "92eda7d8b60128b17061796c6f61645f7369676e617475726583a474797065a84f5045"
                "4e5f42414fd92061636365707465725f6f70656e62616f5f656e746974795f616c6961"
                "735f6964d92465376430376532612d623035642d656335392d646366322d3434303365"
                "66646266316237a97369676e6174757265d9617661756c743a76313a43346a525a782b"
                "796d4c6f753236744e3851324b44793436644134375737782f4d48366e75455a567164"
                "7a2b483052766f614662515541486365424b68422b516f773271584158695246414657"
                "4b47505a55393343513d3d"
            ).as_ref(),
            ...
            authenticated_cmds::async_enrollment_accept::Req {
                ...
                payload_signature: authenticated_cmds::async_enrollment_accept::PayloadSignature::OpenBao {
                    signature: "vault:v1:C4jRZx+ymLou26tN8Q2KDy46dA47W7x/MH6nuEZVqdz+H0RvoaFbQUAHceBKhB+Qow2qXAXiRFAFWKGPZU93CQ==".to_owned(),
                    accepter_openbao_entity_alias_id: "e7d07e2a-b05d-ec59-dcf2-4403efdbf1b7".to_owned(),
                },
            }
        ),
    ] {
...
pub fn rep_invalid_payload() {
    ...
    let expected = authenticated_cmds::async_enrollment_accept::Rep::InvalidPayload;
    println!("***expected: {:?}", expected.dump().unwrap());
...
pub fn rep_invalid_payload_signature() {
    ...
    let expected = authenticated_cmds::async_enrollment_accept::Rep::InvalidPayloadSignature;
    println!("***expected: {:?}", expected.dump().unwrap());
