...
pub fn rep_ok() {
    ...
    let raw: &[u8] = hex!(
        ...
        "745f6964d8027c021dd1e2cd4c328f00dd6e64b89279a77061796c6f6164c4e60028b5"
        "2ffd0058e50600e40c85a474797065bf6173796e635f656e726f6c6c6d656e745f7375"
        "626d69745f7061796c6f6164aa7665726966795f6b6579c420845415cd821748005054"
        "dba8d456ac18ad3e71acdf980e19d6a925191362c9f9aa7075626c6963e1b20b860a78"
        "ef778d0c776121c7027cd90ce04b4d2f1a291a48d911f145724db67265717565737465"
        "645f6465766963655f6c6162656caf4d792064657631206d616368696e6568756d616e"
        "5f68616e646c6592b1616c696365406578616d706c652e636f6db2416c69636579204d"
        "634661636503006111e550ca8406077506b17061796c6f61645f7369676e6174757265"
        "85a474797065a3504b49a9616c676f726974686db15253415353412d5053532d534841"
        "323536d922696e7465726d6564696174655f6465725f783530395f6365727469666963"
        "6174657392c4213c696e7465726d656469617465203120783530392063657274696669"
        "636174653ec4213c696e7465726d656469617465203220783530392063657274696669"
        "636174653ea97369676e6174757265c40b3c7369676e61747572653ebe7375626d6974"
        "7465725f6465725f783530395f6365727469666963617465c41c3c7375626d69747465"
        "7220783530392063657274696669636174653eac7375626d69747465645f6f6ed70100"
        "035d02156e4d4084ad656e726f6c6c6d656e745f6964d802ea778fb3bca142d2bb116e"
        "a5f1b51667a77061796c6f6164c4e60028b52ffd0058e50600e40c85a474797065bf61"
        ...
        "b17061796c6f61645f7369676e617475726583a474797065a84f50454e5f42414fa973"
        "69676e6174757265d9617661756c743a76313a43346a525a782b796d4c6f753236744e"
        "3851324b44793436644134375737782f4d48366e75455a5671647a2b483052766f6146"
        "62515541486365424b68422b516f7732715841586952464146574b47505a5539334351"
        "3d3dd9217375626d69747465725f6f70656e62616f5f656e746974795f616c6961735f"
        "6964d92465376430376532612d623035642d656335392d646366322d34343033656664"
        "6266316237ac7375626d69747465645f6f6ed70100035f86aa90ba80"
    )
    .as_ref();
    ...
    let expected = authenticated_cmds::async_enrollment_list::Rep::Ok {
        enrollments: vec![
            authenticated_cmds::async_enrollment_list::Enrollment {
                ...
                payload_signature: authenticated_cmds::async_enrollment_list::PayloadSignature::PKI {
            ...
            authenticated_cmds::async_enrollment_list::Enrollment {
                ...
                payload_signature: authenticated_cmds::async_enrollment_list::PayloadSignature::OpenBao {
