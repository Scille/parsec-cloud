...
pub fn req() {
    ...
    let raw: &[u8] = hex!(
        "84a3636d64b2746f74705f73657475705f636f6e6669726da7757365725f6964d80285"
        "a277d37f664edcb8bab56f225c9c3da5746f6b656ec410a1b2c3d4e5f6a7b8c9d0e1f2"
        "a3b4c5d6b16f6e655f74696d655f70617373776f7264a6313233343536"
    )
    .as_ref();

    let req = anonymous_cmds::totp_setup_confirm::Req {
    ...
    let expected = anonymous_cmds::AnyCmdReq::TotpSetupConfirm(req);
    ...
    let anonymous_cmds::AnyCmdReq::TotpSetupConfirm(req2) = data else {
        unreachable!()
    };
...
pub fn rep_ok() {
    ...
    let expected = anonymous_cmds::totp_setup_confirm::Rep::Ok;

    println!("***expected: {:?}", expected.dump().unwrap());

    let data = anonymous_cmds::totp_setup_confirm::Rep::load(raw).unwrap();
    ...
    let data2 = anonymous_cmds::totp_setup_confirm::Rep::load(&raw2).unwrap();
...
pub fn rep_invalid_one_time_password() {
    ...
    let expected = anonymous_cmds::totp_setup_confirm::Rep::InvalidOneTimePassword;
...
pub fn rep_bad_token() {
    ...
    let expected = anonymous_cmds::totp_setup_confirm::Rep::BadToken;
