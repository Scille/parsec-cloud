...
pub fn req() {
    ...
    let raw: &[u8] = hex!(
        "88a3636d64b5706b695f656e726f6c6c6d656e745f7375626d6974ad656e726f6c6c6d"
        "656e745f6964d802e1fe88bd0f054261887a6c8039710b40a5666f726365c3b4646572"
        "5f783530395f6365727469666963617465c40d3c78353039206365727469663ed92269"
        "6e7465726d6564696174655f6465725f783530395f63657274696669636174657391c4"
        "086465616462656566b17061796c6f61645f7369676e6174757265c40b3c7369676e61"
        "747572653ebb7061796c6f61645f7369676e61747572655f616c676f726974686db152"
        "53415353412d5053532d534841323536a77061796c6f6164c4073c64756d6d793e"
    )
    .as_ref();
    let req = anonymous_cmds::pki_enrollment_submit::Req {
        der_x509_certificate: hex!("3c78353039206365727469663e").as_ref().into(),
        intermediate_der_x509_certificates: vec![b"deadbeef".as_slice().into()],
