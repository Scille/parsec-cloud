...
pub fn req() {
    ...
    let req = anonymous_server_cmds::account_create_send_validation_email::Req {
        email: "alice@invalid.com".parse().unwrap(),
    };

    let expected = anonymous_server_cmds::AnyCmdReq::AccountCreateSendValidationEmail(req.clone());
    ...
    let anonymous_server_cmds::AnyCmdReq::AccountCreateSendValidationEmail(req2) = data else {
        unreachable!()
    };
...
pub fn rep_ok() {
    ...
    let expected = anonymous_server_cmds::account_create_send_validation_email::Rep::Ok {};

    let data = anonymous_server_cmds::account_create_send_validation_email::Rep::load(raw).unwrap();
    p_assert_eq!(data, expected);
    ...
    let data2 =
        anonymous_server_cmds::account_create_send_validation_email::Rep::load(&raw2).unwrap();
...
pub fn rep_email_server_unavailable() {
    ...
    let expected =
        anonymous_server_cmds::account_create_send_validation_email::Rep::EmailServerUnavailable {};
    let data = anonymous_server_cmds::account_create_send_validation_email::Rep::load(raw).unwrap();
...
pub fn rep_email_recipient_refused() {
    ...
    let expected =
        anonymous_server_cmds::account_create_send_validation_email::Rep::EmailRecipientRefused {};
    let data = anonymous_server_cmds::account_create_send_validation_email::Rep::load(raw).unwrap();
    println!("***expected: {:?}", expected.dump().unwrap());
    p_assert_eq!(data, expected);
...
pub fn rep_email_sending_rate_limited() {
    ...
    let expected =
        anonymous_server_cmds::account_create_send_validation_email::Rep::EmailSendingRateLimited {
