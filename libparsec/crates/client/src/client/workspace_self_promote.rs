...
pub enum ClientSelfPromoteToWorkspaceOwnerError {
    ...
    RealmDeleted,
    #[error("As a user with profile OUTSIDER, author is not allowed")]
    AuthorIsOutsider,
    #[error("Author is not the member of the workspace with the highest role")]
    AuthorNotAllowed,
...
pub async fn self_promote_to_workspace_owner(
    ...
    let outcome = client
        ...
        .map_err(|e| match e {
            ...
            CertifSelfPromoteToOwnerError::AuthorIsOutsider => {
                ClientSelfPromoteToWorkspaceOwnerError::AuthorIsOutsider
            }
