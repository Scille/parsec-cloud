...
use libparsec_platform_pki::{decrypt_message, encrypt_message, EncryptionAlgorithm};
...
pub(super) async fn load_ciphertext_key(
    ...
    match (access, &device_file) {
        ...
        (
            ...
            EncryptionAlgorithm::RsaesOaepSha256,
    ...
    match access {
        ...
        DeviceAccessStrategy::Smartcard {
            ...
            let file_content = DeviceFile::Smartcard(DeviceFileSmartcard {
                ...
                human_handle: device.human_handle.to_owned(),
                device_label: device.device_label.to_owned(),
                certificate_id: encrypted_message.cert_ref.id,
                certificate_sha1: Bytes::copy_from_slice(encrypted_message.cert_ref.hash.as_ref()),
