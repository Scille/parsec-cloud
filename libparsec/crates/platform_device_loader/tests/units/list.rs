...
async fn list_devices(tmp_path: TmpPath) {
    ...
    let smartcard_expected = DeviceFileSmartcard {
        ...
        certificate_ref: CertificateReference::Id(Bytes::copy_from_slice(b"Mallory's certificate")),
    ...
    let smartcard_raw: &[u8] = hex!(
        ...
        "504331af63657274696669636174655f72656683a474797065b5636572746966696361"
        "74655f7265666572656e6365ae63657274696669636174655f6964c4154d616c6c6f72"
        "792773206365727469666963617465b063657274696669636174655f68617368c0bb61"
        "6c676f726974686d5f666f725f656e637279707465645f6b6579b152534145532d4f41"
        "45502d534841323536ad656e637279707465645f6b6579c420de5c59cfcc0c52bf9975"
