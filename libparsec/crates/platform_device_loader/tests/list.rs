...
async fn list_devices(tmp_path: TmpPath) {
    ...
    // Generated from Rust implementation (Parsec v3.0.0-a.0 2024-03-19)
    // Content:
    // ```rust
    // let bob_device = DeviceFileSmartcard {
    //     encrypted_key: hex!("de5c59cfcc0c52bf997594e0fdd2c24ffee9465b6f25e30bac9238c2f83fd19a")
    //         .as_ref()
    //         .into(),
    //     certificate_id: "Bob's certificate".into(),
    ...
    //     device_label: DeviceLabel::try_from("My dev2 machine").unwrap(),
    //     device_id: DeviceID::try_from(
    //         "cc2578be6a174c9590a98b7d0d2c7e4f@6b92acd628294292a4b126b3e875c686",
    //     )
    //     .unwrap(),
    //     organization_id: OrganizationID::try_from("CoolOrg").unwrap(),
    //     slug:
    //         "f78292422e#CoolOrg#cc2578be6a174c9590a98b7d0d2c7e4f@6b92acd628294292a4b126b3e875c686"
    //             .into(),
    // };
    // std::fs::write("bob_device.bin", DeviceFile::Smartcard(bob_device).dump()).unwrap();
    // ```

    let bob_file_content = hex!(
        "8aa474797065a9736d61727463617264aa63697068657274657874c40a636970"
        "68657274657874ac68756d616e5f68616e646c6592af626f62406578616d706c"
        "652e636f6dae426f6279204d63426f6246616365ac6465766963655f6c616265"
        "6caf4d792064657632206d616368696e65a96465766963655f6964d941636332"
        "3537386265366131373463393539306139386237643064326337653466403662"
        "393261636436323832393432393261346231323662336538373563363836af6f"
        "7267616e697a6174696f6e5f6964a7436f6f6c4f7267a4736c7567d954663738"
        "3239323432326523436f6f6c4f72672363633235373862653661313734633935"
        "3930613938623764306432633765346640366239326163643632383239343239"
        "3261346231323662336538373563363836ad656e637279707465645f6b6579c4"
        "20de5c59cfcc0c52bf997594e0fdd2c24ffee9465b6f25e30bac9238c2f83fd1"
        "9aae63657274696669636174655f6964b1426f62277320636572746966696361"
        "7465b263657274696669636174655f736861323536c4144682e01bc3e22fdfff"
        "1c33b551dfad8e49295005"
    );
