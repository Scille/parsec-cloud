...
#[case::realm_roles_updated_without_role(
...
#[case::realm_roles_updated_with_role(
    // Generated from Python implementation (Parsec v2.6.0+dev)
    // Content:
    //   event: "realm.roles_updated"
    //   realm_id: ext(2, hex!("1d3353157d7d4e95ad2fdea7b3bd19c5"))
...
#[case::realm_archiving_updated(
    ...
    &hex!(
        ...
        "61746564ad636f6e66696775726174696f6e81a474797065a84152434849564544a8726561"
...
fn serde_events_listen_rep(
    #[case] raw: &[u8],
    #[case] expected: authenticated_cmds::events_listen::Rep,
) {
