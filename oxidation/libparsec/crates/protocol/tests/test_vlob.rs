...
fn serde_vlob_create_req(#[case] raw: &[u8], #[case] expected: authenticated_cmds::AnyCmdReq) {
...
fn serde_vlob_update_req(#[case] raw: &[u8], #[case] expected: authenticated_cmds::AnyCmdReq) {
    let data = authenticated_cmds::AnyCmdReq::load(raw).unwrap();
