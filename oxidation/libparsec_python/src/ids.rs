...
pub(crate) struct OrganizationID(pub libparsec::api_types::OrganizationID);
...
impl OrganizationID {
    ...
    fn new(organization_id: &PyAny) -> PyResult<Self> {
        if let Ok(organization_id) = organization_id.extract::<Self>() {
            ...
            match organization_id.parse::<libparsec::api_types::OrganizationID>() {
...
pub(crate) struct EntryID(pub libparsec::api_types::EntryID);
...
impl EntryID {
        ...
        match uuid.getattr("hex") {
            Ok(as_hex) => {
                ...
                match Uuid::parse_str(u) {
                    Ok(as_uuid) => Ok(Self(libparsec::api_types::EntryID::from(as_uuid))),
    ...
    fn from_bytes(_cls: &PyType, bytes: &PyBytes) -> PyResult<Self> {
        ...
        match uuid::Uuid::from_slice(b) {
            Ok(uuid) => Ok(Self(libparsec::api_types::EntryID::from(uuid))),
    ...
    pub fn from_hex(_cls: &PyType, hex: &PyString) -> PyResult<Self> {
        match hex.to_string().parse::<libparsec::api_types::EntryID>() {
    ...
    fn _class_new(_cls: &PyType) -> PyResult<Self> {
        Ok(Self(libparsec::api_types::EntryID::default()))
    }
...
#[pyclass]
#[derive(PartialEq, Eq, Clone)]
pub(crate) struct BlockID(pub libparsec::api_types::BlockID);
...
impl BlockID {
    ...
    pub fn new(uuid: &PyAny) -> PyResult<Self> {
        ...
        match uuid.getattr("hex") {
            Ok(as_hex) => {
                ...
                // Parse it as a Rust Uuid
                match Uuid::parse_str(u) {
                    Ok(as_uuid) => Ok(Self(libparsec::api_types::BlockID::from(as_uuid))),
                    Err(_) => Err(PyValueError::new_err("Not a UUID")),
                }
            }
            Err(_) => Err(PyValueError::new_err("Not a UUID")),
    ...
    fn from_bytes(_cls: &PyType, bytes: &PyBytes) -> PyResult<Self> {
        let b = bytes.as_bytes();
        match uuid::Uuid::from_slice(b) {
            Ok(uuid) => Ok(Self(libparsec::api_types::BlockID::from(uuid))),
            Err(_) => Err(PyValueError::new_err("Invalid UUID")),
        }
    }
    ...
    fn from_hex(_cls: &PyType, hex: &PyString) -> PyResult<Self> {
        match hex.to_string().parse::<libparsec::api_types::BlockID>() {
            Ok(entry_id) => Ok(Self(entry_id)),
            Err(err) => Err(PyValueError::new_err(err)),
        }
    }
    ...
    #[pyo3(name = "new")]
    fn _class_new(_cls: &PyType) -> PyResult<Self> {
        Ok(Self(libparsec::api_types::BlockID::default()))
    }
...
#[pyclass]
#[derive(PartialEq, Eq, Clone)]
pub(crate) struct RealmID(pub libparsec::api_types::RealmID);
...
impl RealmID {
    ...
    pub fn new(uuid: &PyAny) -> PyResult<Self> {
        ...
        match uuid.getattr("hex") {
            Ok(as_hex) => {
                ...
                // Parse it as a Rust Uuid
                match Uuid::parse_str(u) {
                    Ok(as_uuid) => Ok(Self(libparsec::api_types::RealmID::from(as_uuid))),
                    Err(_) => Err(PyValueError::new_err("Not a UUID")),
                }
            }
            Err(_) => Err(PyValueError::new_err("Not a UUID")),
    ...
    fn from_bytes(_cls: &PyType, bytes: &PyBytes) -> PyResult<Self> {
        let b = bytes.as_bytes();
        match uuid::Uuid::from_slice(b) {
            Ok(uuid) => Ok(Self(libparsec::api_types::RealmID::from(uuid))),
            Err(_) => Err(PyValueError::new_err("Invalid UUID")),
        }
    }
    ...
    #[classmethod]
    fn from_hex(_cls: &PyType, hex: &PyString) -> PyResult<Self> {
        match hex.to_string().parse::<libparsec::api_types::RealmID>() {
            Ok(entry_id) => Ok(Self(entry_id)),
            Err(err) => Err(PyValueError::new_err(err)),
        }
    }
    ...
    #[pyo3(name = "new")]
    fn _class_new(_cls: &PyType) -> PyResult<Self> {
        Ok(Self(libparsec::api_types::RealmID::default()))
    }
...
#[pyclass]
#[derive(PartialEq, Eq, Clone, Hash)]
pub(crate) struct VlobID(pub libparsec::api_types::VlobID);
...
impl VlobID {
    ...
    pub fn new(uuid: &PyAny) -> PyResult<Self> {
        ...
        match uuid.getattr("hex") {
            Ok(as_hex) => {
                ...
                // Parse it as a Rust Uuid
                match Uuid::parse_str(u) {
                    Ok(as_uuid) => Ok(Self(libparsec::api_types::VlobID::from(as_uuid))),
                    Err(_) => Err(PyValueError::new_err("Not a UUID")),
                }
            }
            Err(_) => Err(PyValueError::new_err("Not a UUID")),
    ...
    fn from_bytes(_cls: &PyType, bytes: &PyBytes) -> PyResult<Self> {
        let b = bytes.as_bytes();
        match uuid::Uuid::from_slice(b) {
            Ok(uuid) => Ok(Self(libparsec::api_types::VlobID::from(uuid))),
            Err(_) => Err(PyValueError::new_err("Invalid UUID")),
        }
    }
    ...
    #[classmethod]
    fn from_hex(_cls: &PyType, hex: &PyString) -> PyResult<Self> {
        match hex.to_string().parse::<libparsec::api_types::VlobID>() {
            Ok(entry_id) => Ok(Self(entry_id)),
            Err(err) => Err(PyValueError::new_err(err)),
        }
    }
    ...
    #[pyo3(name = "new")]
    fn _class_new(_cls: &PyType) -> PyResult<Self> {
        Ok(Self(libparsec::api_types::VlobID::default()))
    }
...
#[pyclass]
#[derive(PartialEq, Eq, Clone, Hash)]
pub(crate) struct UserID(pub libparsec::api_types::UserID);
...
impl UserID {
    ...
    fn new(user_id: &PyAny) -> PyResult<Self> {
        if let Ok(user_id) = user_id.extract::<Self>() {
            ...
            match user_id.parse::<libparsec::api_types::UserID>() {
...
#[pyclass]
#[derive(PartialEq, Eq, Clone)]
pub(crate) struct DeviceName(pub libparsec::api_types::DeviceName);
...
impl DeviceName {
    ...
    fn new(device_name: &PyAny) -> PyResult<Self> {
        if let Ok(device_name) = device_name.extract::<Self>() {
            ...
            match device_name.parse::<libparsec::api_types::DeviceName>() {
    ...
    #[pyo3(name = "new")]
    fn _class_new(_cls: &PyType) -> PyResult<Self> {
        Ok(Self(libparsec::api_types::DeviceName::default()))
    }
}

#[pyclass]
#[derive(PartialEq, Eq, Clone)]
pub(crate) struct DeviceLabel(pub libparsec::api_types::DeviceLabel);
...
impl DeviceLabel {
    ...
    fn new(device_label: &PyAny) -> PyResult<Self> {
        if let Ok(device_label) = device_label.extract::<Self>() {
            ...
            match device_label.parse::<libparsec::api_types::DeviceLabel>() {
...
#[pyclass]
#[derive(PartialEq, Eq, Clone)]
pub(crate) struct DeviceID(pub libparsec::api_types::DeviceID);
...
impl DeviceID {
    ...
    fn new(device_id: &PyAny) -> PyResult<Self> {
        if let Ok(device_id) = device_id.extract::<Self>() {
            ...
            match device_id.parse::<libparsec::api_types::DeviceID>() {
    ...
    #[pyo3(name = "new")]
    fn _class_new(_cls: &PyType) -> PyResult<Self> {
        Ok(Self(libparsec::api_types::DeviceID::default()))
    }
}

#[pyclass]
#[derive(PartialEq, Eq, Clone, Hash)]
pub(crate) struct ChunkID(pub libparsec::api_types::ChunkID);
...
impl ChunkID {
    ...
    pub fn new(uuid: &PyAny) -> PyResult<Self> {
        ...
        match uuid.getattr("hex") {
            Ok(as_hex) => {
                ...
                // Parse it as a Rust Uuid
                match Uuid::parse_str(u) {
                    Ok(as_uuid) => Ok(Self(libparsec::api_types::ChunkID::from(as_uuid))),
                    Err(_) => Err(PyValueError::new_err("Not a UUID")),
                }
            }
            Err(_) => Err(PyValueError::new_err("Not a UUID")),
    ...
    fn from_bytes(_cls: &PyType, bytes: &PyBytes) -> PyResult<Self> {
        let b = bytes.as_bytes();
        match uuid::Uuid::from_slice(b) {
            Ok(uuid) => Ok(Self(libparsec::api_types::ChunkID::from(uuid))),
            Err(_) => Err(PyValueError::new_err("Invalid UUID")),
        }
    }
    ...
    #[classmethod]
    fn from_hex(_cls: &PyType, hex: &PyString) -> PyResult<Self> {
        match hex.to_string().parse::<libparsec::api_types::ChunkID>() {
            Ok(entry_id) => Ok(Self(entry_id)),
            Err(err) => Err(PyValueError::new_err(err)),
        }
    }
    ...
    #[pyo3(name = "new")]
    fn _class_new(_cls: &PyType) -> PyResult<Self> {
        Ok(Self(libparsec::api_types::ChunkID::default()))
    }
...
#[pyclass]
#[derive(PartialEq, Eq, Clone)]
pub(crate) struct HumanHandle(pub libparsec::api_types::HumanHandle);

#[pymethods]
impl HumanHandle {
    #[new]
    pub fn new(email: &str, label: &str) -> PyResult<Self> {
        match libparsec::api_types::HumanHandle::new(email, label) {
