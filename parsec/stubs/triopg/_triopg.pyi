...
class TrioPoolProxy:
    ...
    async def executemany(self, statement: str, args, *, timeout: float | None = None) -> Any: ...
    async def fetch(self, query, *args, timeout: float | None = None) -> Any: ...
    async def fetchval(self, query, *args, timeout: float | None = None) -> Any: ...
    async def fetchrow(self, query, *args, timeout: float | None = None) -> Any: ...
    async def close(self) -> Any: ...
