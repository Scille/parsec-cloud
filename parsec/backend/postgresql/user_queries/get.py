...
async def query_get_user_with_devices_and_trustchain(
    ...
    return GetUserAndDevicesResult(
        ...
        trustchain_device_certificates=list(trustchain.devices),
        trustchain_user_certificates=list(trustchain.users),
        trustchain_revoked_user_certificates=list(trustchain.revoked_users),
    )
