...
class InvitationType:
    ...
    @classmethod
    def DEVICE(cls) -> InvitationType: ...
    @classmethod
    def USER(cls) -> InvitationType: ...
...
class Invite4ClaimerCommunicateRepActiveUserLimitReached(Invite4ClaimerCommunicateRep):
    def __init__(self) -> None: ...
...
class EventsListenRep:
    def __init__(self) -> None: ...
    @classmethod
    def OkPinged(cls, ping: str) -> EventsListenRep: ...
    @classmethod
    def OkMessageReveived(cls, index: int) -> EventsListenRep: ...
    @classmethod
    def OkInviteStatusChanged(
        cls, token: InvitationToken, invitation_status: Any
    ) -> EventsListenRep: ...
    @classmethod
    def OkRealMaintenanceFinished(
        cls, realm_id: RealmID, encryption_revision: int
    ) -> EventsListenRep: ...
    @classmethod
    def OkRealmMaintenanceStarted(
        cls, realm_id: RealmID, encryption_revision: int
    ) -> EventsListenRep: ...
    @classmethod
    def OkRealmVlobsUpdated(
        cls, realm_id: RealmID, checkpoint: int, src_id, VlobID, src_version: int
    ) -> EventsListenRep: ...
    @classmethod
    def OkRealmRolesUpdated(cls, realm_id: RealmID, role: Any) -> EventsListenRep: ...
    @classmethod
    def Cancelled(cls, reasom: Optional[str]) -> EventsListenRep: ...
    @classmethod
    def NoEvents(cls) -> EventsListenRep: ...
    @property
    def ping(self) -> str: ...
    @property
    def token(self) -> InvitationToken: ...
