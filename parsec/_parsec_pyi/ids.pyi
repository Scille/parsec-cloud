...
class RealmID:
    ...
    @classmethod
    def from_str(cls, hex: str) -> RealmID: ...
    @classmethod
    def new(cls) -> RealmID: ...
    @property
    def uuid(self) -> UUID: ...
...
class BlockID:
    ...
    @classmethod
    def from_str(cls, hex: str) -> BlockID: ...
    @classmethod
    def new(cls) -> BlockID: ...
    @property
    def uuid(self) -> UUID: ...
...
class VlobID:
    ...
    @classmethod
    def from_str(cls, hex: str) -> VlobID: ...
    @classmethod
    def new(cls) -> VlobID: ...
    @property
    def uuid(self) -> UUID: ...
...
class EntryID:
    ...
    @classmethod
    def from_str(cls, hex: str) -> EntryID: ...
    @classmethod
    def new(cls) -> EntryID: ...
    @property
    def uuid(self) -> UUID: ...
...
class ChunkID:
    ...
    @classmethod
    def from_str(cls, hex: str) -> ChunkID: ...
    @classmethod
    def new(cls) -> ChunkID: ...
    @property
    def uuid(self) -> UUID: ...
...
class SequesterServiceID:
    ...
    @classmethod
    def from_str(cls, hex: str) -> SequesterServiceID: ...
    @classmethod
