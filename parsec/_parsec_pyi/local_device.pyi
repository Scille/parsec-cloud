...
class LocalDevice:
    ...
    @classmethod
    def load_device_with_keyring(cls, key_file: Path) -> LocalDevice: ...
    @classmethod
    def load_device_with_biometrics(cls, key_file: Path) -> LocalDevice: ...
    @classmethod
...
def save_device_with_keyring(key_file: Path, device: LocalDevice, force: bool) -> None: ...
def save_device_with_keyring_in_config(
    config_dir: Path,
    device: LocalDevice,
) -> Path: ...
def save_device_with_biometrics(key_file: Path, device: LocalDevice, force: bool) -> None: ...
def save_device_with_biometrics_in_config(
    config_dir: Path,
    device: LocalDevice,
) -> Path: ...
