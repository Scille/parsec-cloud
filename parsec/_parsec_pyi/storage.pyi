...
class WorkspaceStorageSnapshot:
    def __init__(self, workspace_storage: WorkspaceStorage) -> "WorkspaceStorageSnapshot": ...
    def create_file_descriptor(self, manifest: LocalFileManifest) -> int: ...
    def load_file_descriptor(self, fd: int) -> LocalFileManifest: ...
    def remove_file_descriptor(self, fd: int): ...
    def get_chunk(self, chunk_id: ChunkID) -> bytes: ...
    def get_workspace_manifest(self) -> LocalWorkspaceManifest: ...
    def get_manifest(self, entry_id: EntryID) -> AnyLocalManifest: ...
    def set_manifest(self, entry_id: EntryID, manifest: AnyLocalManifest): ...
    def get_prevent_sync_pattern(self) -> Pattern[str]: ...
    def get_prevent_sync_pattern_fully_applied(self) -> bool: ...
    def set_clean_block(self, block_id: BlockID, block: bytes): ...
