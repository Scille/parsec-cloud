...
# def list_enrollment(config_dir) -> List[LocalEnrollmentRequest]:
#     # Sync si possible
#     pass

# def has_enrollment_requests(config_dir) -> bool:
#    # Doit être sync
#    # Dans certains cas on veut juste savoir si y'a des requests et c'compliqué d'appeler une fonction async pour ça.
#    pass

# async def get_enrollment_status(request: LocalEnrollmentRequest) -> Object:
#    # Construit l'url, fait la requête HTTP, la désérialisation, ...
#    # Retourne un objet qui wrap request, query_info et status avec des properties
#    pass

# def generate_new_device_from_request(Object) -> LocalDevice:
#    # Construit un device à partir de l'objet retourné par get_enrollment_status
#    # S'occupe de récupérer les clefs, de construire l'adresse du backend, ...
#    pass


# def clear_request(config_dir, LocalEnrollmentRequest):
#    # S'occupe du unlink()
#    # Si sync c'est plus simple, sinon on f'ra avec de l'async
#    pass
...
#     ).dump()
#     submiter_der_x509_certificate: bytes
#     submit_payload_signature: bytes
#     (
#         submiter_der_x509_certificate,
#         submit_payload_signature,
#     ) = smartcard.pki_enrollment_sign_payload(payload=submit_payload)

#     rep = await cmd_pki_enrollment_submit(
#         addr=invitation_address,
#         enrollment_id=enrollment_id,
#         force=force,
#         submitter_der_x509_certificate=submitter_der_x509_certificate,
#         submit_payload_signature=submit_payload_signature,
