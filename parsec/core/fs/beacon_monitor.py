...
# async def monitor_beacons(device, local_folder_fs, event_bus):
#     workspaces = {}

#     for beacon_id in local_folder_fs.get_local_beacons():
...
#         try:
#             workspace_path = _retreive_workspace_from_beacon(device, local_folder_fs, beacon_id)
...
# def _retreive_workspace_from_beacon(device, local_folder_fs, beacon_id):
#     root_manifest = local_folder_fs.get_manifest(device.user_manifest_access)
...
#         child_manifest = local_folder_fs.get_manifest(child_access)
