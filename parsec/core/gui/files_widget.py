...
class FilesWidget(QWidget, Ui_FilesWidget):
    ...
    def __init__(self, core, jobs_ctx, event_bus, *args, **kwargs):
        ...
        self.button_back = TaskbarButton(icon_path=":/icons/images/icons/tray_icons/back.svg")
        ...
        self.button_import_folder = TaskbarButton(
            icon_path=":/icons/images/icons/tray_icons/folder.svg"
        )
        ...
        self.button_import_files = TaskbarButton(
            icon_path=":/icons/images/icons/tray_icons/file.svg"
        )
        ...
        self.button_create_folder = TaskbarButton(
            icon_path=":/icons/images/icons/tray_icons/plus.svg"
        )
