...
# Form implementation generated from reading ui file 'forms/new_login_register_user_widget.ui'
#
...
class Ui_LoginRegisterUserWidget(object):
    def setupUi(self, LoginRegisterUserWidget):
        ...
        LoginRegisterUserWidget.resize(628, 856)
        ...
        self.label_9 = QtWidgets.QLabel(LoginRegisterUserWidget)
        font = QtGui.QFont()
        ...
        self.widget = QtWidgets.QWidget(LoginRegisterUserWidget)
        ...
        self.verticalLayout.addWidget(self.line_edit_login)
        ...
        self.verticalLayout.addWidget(self.line_edit_device)
        ...
        self.verticalLayout_2.addWidget(self.line_edit_password_check)
        ...
        self.verticalLayout_3.addWidget(self.line_edit_nitrokey_pin)
        ...
        self.verticalLayout_3.addWidget(self.combo_nitrokey_token)
        ...
        self.verticalLayout_3.addWidget(self.combo_nitrokey_key)
    ...
    def retranslateUi(self, LoginRegisterUserWidget):
        ...
        self.label_6.setText(_translate("LoginRegisterUserWidget", "Password check"))
        self.label_3.setText(_translate("LoginRegisterUserWidget", "NitroKey PIN"))
        self.label_4.setText(_translate("LoginRegisterUserWidget", "NitroKey Token"))
        self.label_5.setText(_translate("LoginRegisterUserWidget", "NitroKey Key"))
        self.check_box_use_nitrokey.setText(
            _translate("LoginRegisterUserWidget", "Authenticate using NitroKey")
        )
