...
class Ui_UsersWidget(object):
    def setupUi(self, UsersWidget):
        ...
        self.line_edit_new_login = QtWidgets.QLineEdit(self.groupBox)
        self.line_edit_new_login.setObjectName("line_edit_new_login")
        self.horizontalLayout_3.addWidget(self.line_edit_new_login)
    ...
    def retranslateUi(self, UsersWidget):
        ...
        self.line_edit_new_login.setPlaceholderText(_translate("UsersWidget", "New user name"))
