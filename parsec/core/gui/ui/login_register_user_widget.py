...
class Ui_LoginRegisterUserWidget(object):
    def setupUi(self, LoginRegisterUserWidget):
        ...
        LoginRegisterUserWidget.setStyleSheet(
            "QWidget#LoginRegisterUserWidget\n" "{\n" "background-color: rgb(12, 65, 156);\n" "}"
        )
        ...
        self.verticalLayout_8.addWidget(self.line_edit_token)
        ...
        self.verticalLayout_12.addWidget(self.line_edit_nitrokey_pin)
        ...
        self.verticalLayout_13.addWidget(self.combo_nitrokey_token)
        ...
        self.verticalLayout_14.addWidget(self.combo_nitrokey_key)
