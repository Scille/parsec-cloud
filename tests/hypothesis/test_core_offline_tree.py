...
@pytest.mark.slow
def test_core_offline_tree(BaseCoreAloneStateMachine, oracle_fs_factory, hypothesis_settings):
    class CoreOfflineTree(BaseCoreAloneStateMachine):
        Files = Bundle("file")
    ...
    run_state_machine_as_test(CoreOfflineTree, settings=hypothesis_settings)
