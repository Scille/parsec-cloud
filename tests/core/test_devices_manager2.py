...
from parsec.core.devices_manager2.pkcs11_tools import NoKeysFound, DevicePKCS11Error
from parsec.types import DeviceID
from parsec.core.devices_manager2 import (
    generate_new_device,
    LocalDevicesManager,
    DeviceManagerError,
...
def mocked_pkcs11():
    ...
    with patch(
        "parsec.core.devices_manager2.pkcs11_cipher.encrypt_data", new=encrypt_data_mock
    ), patch(
        "parsec.core.devices_manager2.pkcs11_cipher.decrypt_data", new=decrypt_data_mock
    ), patch(
        "parsec.core.devices_manager2.pkcs11_cipher.get_LIB"
    ):
