...
def _populate_factory(user):
    ...
    data['block_store'][up_to_date_txt_block_1_id] = up_to_date_txt_block_1_blob
    ...
    data['block_store'][up_to_date_txt_block_2_id] = up_to_date_txt_block_2_blob
    ...
    data['block_store'][non_local_txt_block_1_id] = non_local_txt_block_1_blob
    ...
    data['block_store'][non_local_txt_block_2_id] = non_local_txt_block_2_blob
    ...
    data['block_store'][modified_txt_block_1_id] = modified_txt_block_1_blob
...
def populate_backend(user, backend, block_store):
