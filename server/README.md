...
Indeed, realm revocation takes a write lock on `common` topic, while all commands involving
...
authenticated | invite_1_greeter_wait_peer             |        |       |           |        |                     |                  |                     |
authenticated | invite_2a_greeter_get_hashed_nonce     |        |       |           |        |                     |                  |                     |
authenticated | invite_2b_greeter_send_nonce           |        |       |           |        |                     |                  |                     |
authenticated | invite_3a_greeter_wait_peer_trust      |        |       |           |        |                     |                  |                     |
authenticated | invite_3b_greeter_signify_trust        |        |       |           |        |                     |                  |                     |
authenticated | invite_4_greeter_communicate           |        |       |           |        |                     |                  |                     |
invited       | invite_1_claimer_wait_peer             |        |       |           |        |                     |                  |                     |
invited       | invite_2a_claimer_send_hashed_nonce    |        |       |           |        |                     |                  |                     |
invited       | invite_2b_claimer_send_nonce           |        |       |           |        |                     |                  |                     |
invited       | invite_3a_claimer_signify_trust        |        |       |           |        |                     |                  |                     |
invited       | invite_3b_claimer_wait_peer_trust      |        |       |           |        |                     |                  |                     |
invited       | invite_4_claimer_communicate           |        |       |           |        |                     |                  |                     |
