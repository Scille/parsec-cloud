...
def _q_update_factory(
    ...
    with_realm_minimum_archiving_period_before_deletion: bool,
    with_tos: bool,
) -> Q:
    fields = []
    if with_is_expired:
    ...
    if with_realm_minimum_archiving_period_before_deletion:
        fields.append(
...
async def organization_update(
    ...
    with_realm_minimum_archiving_period_before_deletion = (
        realm_minimum_archiving_period_before_deletion is not Unset
    )
    ...
    if (
        ...
        and not with_realm_minimum_archiving_period_before_deletion
        and not with_tos
    ):
        # Nothing to update
        return
    ...
    if with_realm_minimum_archiving_period_before_deletion:
        fields["realm_minimum_archiving_period_before_deletion"] = (
    ...
    q = _q_update_factory(
        ...
        with_realm_minimum_archiving_period_before_deletion=with_realm_minimum_archiving_period_before_deletion,
        with_tos=with_tos,
    )
