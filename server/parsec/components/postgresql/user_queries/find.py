...
from parsec.components.postgresql.utils import Q, q_organization_internal_id, query

# from parsec.components.user import HumanFindResultItem
...
async def query_retrieve_active_human_by_email(
    conn: asyncpg.Connection, organization_id: OrganizationID, email: str
) -> UserID | None:
