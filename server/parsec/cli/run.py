...
@click.option(
    ...
    default=120,
    show_default=True,
    envvar="PARSEC_ACCOUNT_DELETION_TOKEN_DURATION",
    show_envvar=True,
    help="How long a deletion token stay valid in seconds",
)
@click.option(
    "--server-addr",
...
def run_cmd(
    ...
    account_deletion_token_duration: int,
    ...
    with cli_exception_handler(debug):
        ...
        app_config = BackendConfig(
            ...
            account_config=AccountConfig(
                ...
                deletion_token_duration=account_deletion_token_duration,
            ),
        )
