...
class AdministrationApiCommonErrors(Enum):
    ORGANIZATION_NOT_FOUND = "organization_not_found"


# A word about error handling in the administration REST API:
# We use status code and body to communicate the error.
#
#
# Standard errors (common for all routes):
# 400:
# 404: The URL points to an unknown resource (typically the organization ID)
# 422:
#
