...
class X509Certificate:
    @classmethod
    def load_pem(cls, raw_pem: bytes) -> X509Certificate: ...
    @classmethod
    def load_der(cls, raw_der: bytes) -> X509Certificate: ...
    @property
...
class X509TrustAnchor:
    @classmethod
    def load_pem(cls, raw_pem: bytes) -> X509TrustAnchor: ...
    @classmethod
    def load_der(cls, raw_der: bytes) -> X509TrustAnchor: ...
    @property
    def subject(self) -> bytes: ...
...
def load_submit_payload(
    ...
    trusted_roots: list[X509TrustAnchor],
    now: DateTime,
