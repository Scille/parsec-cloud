...
class RealmRole:
    ...
    @property
    def str(self) -> str: ...
    def __lt__(self, other: RealmRole | None) -> bool: ...
    def __gt__(self, other: RealmRole | None) -> bool: ...
    def __le__(self, other: RealmRole | None) -> bool: ...
    def __ge__(self, other: RealmRole | None) -> bool: ...
...
class UserProfile:
    ...
    @property
    def str(self) -> str: ...
    def __lt__(self, other: UserProfile | None) -> bool: ...
    def __gt__(self, other: UserProfile | None) -> bool: ...
    def __le__(self, other: UserProfile | None) -> bool: ...
    def __ge__(self, other: UserProfile | None) -> bool: ...
