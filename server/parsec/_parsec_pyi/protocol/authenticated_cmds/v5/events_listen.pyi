...
class APIEventOrganizationConfig(APIEvent):
    def __init__(
        ...
        realm_minimum_archiving_period_before_deletion: int | None,
    ) -> None: ...
    @property
    def active_users_limit(self) -> ActiveUsersLimit: ...
    @property
    def realm_minimum_archiving_period_before_deletion(self) -> int | None: ...
    @property
...
class APIEventInvitation(APIEvent):
    def __init__(self, token: AccessToken, invitation_status: InvitationStatus) -> None: ...
    @property
...
class APIEventGreetingAttemptReady(APIEvent):
    def __init__(self, token: AccessToken, greeting_attempt: GreetingAttemptID) -> None: ...
    @property
