...
class FileManifestOrigin:
    DEFAULT: FileManifestOrigin

    @classmethod
    def cryptpad(cls, channel_id: str, timestamp: DateTime) -> FileManifestOrigin: ...
    @property
...
class FileManifest:
    ...
    @property
    def origin(self) -> FileManifestOrigin: ...
