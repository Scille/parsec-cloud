    ...
    Ok(match event {
        libparsec::low_level::testbed::TestbedEvent::BootstrapOrganization(x) => {
            ...
            let obj = TestbedEventBootstrapOrganization {
                ...
                first_user_first_device_signing_key: x
                    ...
                    .clone()
                    .into(),
                first_user_user_manifest_id: x.first_user_user_manifest_id.into(),
                first_user_user_manifest_key: x.first_user_user_manifest_key.clone().into(),
        ...
        libparsec::low_level::testbed::TestbedEvent::NewUser(x) => {
            ...
            let obj = TestbedEventNewUser {
                ...
                user_manifest_id: x.user_manifest_id.into(),
                user_manifest_key: x.user_manifest_key.clone().into(),
