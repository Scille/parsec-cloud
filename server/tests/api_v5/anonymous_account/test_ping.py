...
async def test_anonymous_account_ping_ok(account: AccountRpcClient, backend: Backend) -> None:
...
async def test_anonymous_account_ping_http_common_errors(
    account: AccountRpcClient, anonymous_account_http_common_errors_tester: HttpCommonErrorsTester
) -> None:
    async def do():
