...
class BaseAuthenticatedRpcClient:
    ...
    async def invite_exchange(
        ...
        last: bool,
        reset_reason: authenticated_cmds.latest.invite_exchange.InviteExchangeResetReason | None,
        ...
        raw_rep = await self._do_request(req.dump())
        return authenticated_cmds.latest.invite_exchange.Rep.load(raw_rep)
...
class BaseInvitedRpcClient:
    ...
    async def invite_exchange(
        ...
        reset_reason: invited_cmds.latest.invite_exchange.InviteExchangeResetReason | None,
    ) -> invited_cmds.latest.invite_exchange.Rep:
        req = invited_cmds.latest.invite_exchange.Req(
            step=step, claimer_payload=claimer_payload, reset_reason=reset_reason
        )
        raw_rep = await self._do_request(req.dump())
        return invited_cmds.latest.invite_exchange.Rep.load(raw_rep)
