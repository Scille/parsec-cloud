...
SELECT
    ...
    SETVAL(PG_GET_SERIAL_SEQUENCE('realm', '_id'), 1000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('realm_user_role', '_id'), 12000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('realm_archiving', '_id'), 13000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('realm_user_change', '_id'), 14000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('realm_keys_bundle', '_id'), 15000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('realm_keys_bundle_access', '_id'), 16000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('realm_sequester_keys_bundle_access', '_id'), 17000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('realm_name', '_id'), 18000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('vlob_atom', '_id'), 19000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('realm_vlob_update', '_id'), 20000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('block', '_id'), 21000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('block_data', '_id'), 22000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('common_topic', '_id'), 23000),
    SETVAL(PG_GET_SERIAL_SEQUENCE('sequester_topic', '_id'), 24000),
