...
async def insert_full_data(
    ...
    zack_u = UserCertificate(
        ...
        user_id=UserID.new(),
        human_handle=HumanHandle("zack@invalid.com", "Zack"),
    ...
    marty_u = UserCertificate(
        ...
        timestamp=DateTime.now(),
        user_id=UserID.new(),
        human_handle=HumanHandle("marty@invalid.com", "Marty Mc Fly"),
        public_key=PrivateKey.generate().public_key,
        algorithm=PrivateKeyAlgorithm.X25519_XSALSA20_POLY1305,
    ...
    doc_u = UserCertificate(
        ...
        timestamp=DateTime.now(),
        user_id=UserID.new(),
        human_handle=HumanHandle("doc@invalid.com", "Doc Emmett Brown"),
        public_key=PrivateKey.generate().public_key,
        algorithm=PrivateKeyAlgorithm.X25519_XSALSA20_POLY1305,
        profile=UserProfile.ADMIN,
    )
