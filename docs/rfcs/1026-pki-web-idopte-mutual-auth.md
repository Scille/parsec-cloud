...
Idopte provide a middleware installed on the client side that provide an HTTP API & JS SDK to provide PKCS11 API in a web context. (see https://www.idopte.com/doc_ug.php)
...
### How Does the Client Retrieve the Certificate
