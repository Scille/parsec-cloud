...
7. The server will ask the metadata server to verify the device ownership proof since it has access to the verify key of the device.
   The request will be cancelled if the proof cannot be verified
