...
[
    {
        ...
        "reps": [
            ...
            {
                // `payload` field doesn't correspond to a valid `AsyncEnrollmentAcceptPayload`
                "status": "invalid_payload"
            },
            {
                // `payload_signature` cannot be verified by the server
...
```json5
{
    ...
    "other_fields": [
        ...
        {
            "name": "encrypted_key",
            "type": "AsyncEnrollmentLocalPendingEncryptedKey"
        },
        {
    ...
    "nested_types": [
        {
            "name": "AsyncEnrollmentLocalPendingEncryptedKey",
            "discriminant_field": "type",
            "variants": [
                {
                    "name": "PKI",
