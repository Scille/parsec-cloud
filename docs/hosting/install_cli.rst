...
.. _Parsec CLI v3.3.3: https://github.com/Scille/parsec-cloud/releases/download/v3.3.3/parsec-cli_3.3.3_linux-x86_64-musl
...
2. Make the file executable
  ...
  - Or use the `chmod` command:
    ...
    .. code-block:: shell
        ...
        chmod +x parsec-cli_3.3.3_linux-x86_64-musl

3. Verify the installation by running the following command:

  .. code-block:: shell

      ./parsec-cli_3.3.3_linux-x86_64-musl --version
