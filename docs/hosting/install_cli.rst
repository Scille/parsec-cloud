...
.. _Parsec CLI: https://github.com/Scille/parsec-cloud/releases/download/v3.9.2-rc.2/parsec-cli_3.9.2-rc.2_linux-x86_64-musl
...
#. Make the file executable:
   ...
   .. code-block:: shell
     ...
     chmod +x parsec-cli_3.9.2-rc.2_linux-x86_64-musl

#. Verify the installation by running the following command:

   .. code-block:: shell

     ./parsec-cli_3.9.2-rc.2_linux-x86_64-musl --version

   Which should display the installed version:

   .. code-block:: text

     parsec-cli 3.9.2-rc.2
