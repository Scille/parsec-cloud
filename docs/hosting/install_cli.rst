...
.. _Parsec CLI v3.2.0: https://github.com/Scille/parsec-cloud/releases/download/v3.2.0/parsec-cli_3.2.0_linux_x86_64
...
2. Make the file executable
  ...
  - Or use the `chmod` command:
    ...
    .. code-block:: shell
        ...
        chmod +x parsec-cli_3.2.0_linux_x86_64

3. Verify the installation by running the following command:

  .. code-block:: shell

      ./parsec-cli_3.2.0_linux_x86_64 --version
