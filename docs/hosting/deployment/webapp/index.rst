...
.. _webapp: https://github.com/Scille/parsec-cloud/releases/download/v3.10.0-rc.3+dev/parsec-web-3.10.0-rc.3+dev.zip
...
#. For the current release, you can download the webapp by using this link: `webapp`_:
   ...
   .. code-block:: shell
      ...
      curl --fail -L -o parsec-web.zip \
        https://github.com/Scille/parsec-cloud/releases/download/v3.10.0-rc.3+dev/parsec-web-3.10.0-rc.3+dev.zip
