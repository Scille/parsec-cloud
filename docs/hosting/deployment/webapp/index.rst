...
.. _webapp: https://github.com/Scille/parsec-cloud/releases/download/v3.9.4-a.0.dev.20686+1cd72fb/parsec-web-3.9.4-a.0.dev.20686+1cd72fb.zip
...
#. For the current release, you can download the webapp by using this link: `webapp`_:
   ...
   .. code-block:: shell
      ...
      curl --fail -L -o parsec-web.zip \
        https://github.com/Scille/parsec-cloud/releases/download/v3.9.4-a.0.dev.20686+1cd72fb/parsec-web-3.9.4-a.0.dev.20686+1cd72fb.zip
