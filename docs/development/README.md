...
2. You need to have the following tools available:
    ...
    2. [`Rust v1.76.0`](https://www.rust-lang.org/fr/learn/get-started)
       ...
       ```shell
       curl --proto '=https' --tlsv1.2 -sSL https://sh.rustup.rs | sh -s -- --default-toolchain none # You can replace `none` with `1.76.0`
       ```
