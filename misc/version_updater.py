...
FILES_WITH_VERSION_INFO: Dict[Path, Dict[Tool, RawRegexes]] = {
    ...
    ROOT_DIR / "packaging/snap/bin/parsec": {Tool.Python: [PYTHON_SMALL_VERSION]},
    ROOT_DIR / "packaging/snap/bin/parsec-cli": {Tool.Python: [PYTHON_SMALL_VERSION]},
    ROOT_DIR / "packaging/snap/snap/snapcraft.yaml": {Tool.Python: [PYTHON_SMALL_VERSION]},
