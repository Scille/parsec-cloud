...
#[allow(dead_code)]
fn variant_client_start_workspace_history2_error_rs_to_js(
    ...
    match rs_obj {
        libparsec::ClientStartWorkspaceHistory2Error::Internal { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"ClientStartWorkspaceHistory2ErrorInternal".into(),
            )?;
        }
        libparsec::ClientStartWorkspaceHistory2Error::InvalidCertificate { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"ClientStartWorkspaceHistory2ErrorInvalidCertificate".into(),
            )?;
        }
        libparsec::ClientStartWorkspaceHistory2Error::InvalidKeysBundle { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"ClientStartWorkspaceHistory2ErrorInvalidKeysBundle".into(),
            )?;
        }
        libparsec::ClientStartWorkspaceHistory2Error::InvalidManifest { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"ClientStartWorkspaceHistory2ErrorInvalidManifest".into(),
            )?;
        }
        libparsec::ClientStartWorkspaceHistory2Error::NoHistory { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"ClientStartWorkspaceHistory2ErrorNoHistory".into(),
            )?;
        }
        libparsec::ClientStartWorkspaceHistory2Error::NoRealmAccess { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"ClientStartWorkspaceHistory2ErrorNoRealmAccess".into(),
            )?;
        }
        libparsec::ClientStartWorkspaceHistory2Error::Offline { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"ClientStartWorkspaceHistory2ErrorOffline".into(),
            )?;
        }
        libparsec::ClientStartWorkspaceHistory2Error::Stopped { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"ClientStartWorkspaceHistory2ErrorStopped".into(),
            )?;
        }
    }
    Ok(js_obj)
    ...
    match rs_obj {
        ...
        libparsec::WorkspaceHistoryFdReadError::BlockNotFound { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"WorkspaceHistoryFdReadErrorBlockNotFound".into(),
            )?;
        }
...
#[allow(dead_code)]
fn variant_workspace_history_get_workspace_manifest_v1_timestamp_error_rs_to_js(
    ...
    match rs_obj {
        libparsec::WorkspaceHistoryGetWorkspaceManifestV1TimestampError::Internal { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"WorkspaceHistoryGetWorkspaceManifestV1TimestampErrorInternal".into(),
            )?;
        }
        libparsec::WorkspaceHistoryGetWorkspaceManifestV1TimestampError::InvalidCertificate {
            ...
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"WorkspaceHistoryGetWorkspaceManifestV1TimestampErrorInvalidCertificate".into(),
            )?;
        }
        libparsec::WorkspaceHistoryGetWorkspaceManifestV1TimestampError::InvalidKeysBundle {
            ...
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"WorkspaceHistoryGetWorkspaceManifestV1TimestampErrorInvalidKeysBundle".into(),
            )?;
        }
        libparsec::WorkspaceHistoryGetWorkspaceManifestV1TimestampError::InvalidManifest {
            ...
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"WorkspaceHistoryGetWorkspaceManifestV1TimestampErrorInvalidManifest".into(),
            )?;
        }
        libparsec::WorkspaceHistoryGetWorkspaceManifestV1TimestampError::NoRealmAccess {
            ...
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"WorkspaceHistoryGetWorkspaceManifestV1TimestampErrorNoRealmAccess".into(),
            )?;
        }
        libparsec::WorkspaceHistoryGetWorkspaceManifestV1TimestampError::Offline { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"WorkspaceHistoryGetWorkspaceManifestV1TimestampErrorOffline".into(),
            )?;
        }
        libparsec::WorkspaceHistoryGetWorkspaceManifestV1TimestampError::Stopped { .. } => {
            Reflect::set(
                &js_obj,
                &"tag".into(),
                &"WorkspaceHistoryGetWorkspaceManifestV1TimestampErrorStopped".into(),
            )?;
        }
    }
    Ok(js_obj)
    ...
    future_to_promise(async move {
        ...
        Ok(match ret {
            ...
            Err(err) => {
                let js_obj = Object::new().into();
                Reflect::set(&js_obj, &"ok".into(), &false.into())?;
                let js_err = variant_client_start_workspace_history2_error_rs_to_js(err)?;
                Reflect::set(&js_obj, &"error".into(), &js_err)?;
                js_obj
            }
        })
...
pub fn workspaceHistory2SetTimestampOfInterest(workspace_history: u32, toi: f64) -> Promise {
    future_to_promise(async move {
        ...
        let ret = libparsec::workspace_history2_set_timestamp_of_interest(workspace_history, toi);
        Ok(match ret {
            Ok(value) => {
                let js_obj = Object::new().into();
                Reflect::set(&js_obj, &"ok".into(), &true.into())?;
    ...
    future_to_promise(async move {
        ...
        Ok(match ret {
            ...
            Err(err) => {
                ...
                Reflect::set(&js_obj, &"ok".into(), &false.into())?;
                let js_err =
                    variant_workspace_history_get_workspace_manifest_v1_timestamp_error_rs_to_js(
                        err,
                    )?;
                Reflect::set(&js_obj, &"error".into(), &js_err)?;
                js_obj
...
pub fn workspaceHistoryOpenFile(workspace: u32, at: f64, path: String) -> Promise {
    future_to_promise(async move {
        let at = {
            ...
            custom_from_rs_f64(at).map_err(|e| TypeError::new(e.as_ref()))
        }?;
...
#[allow(non_snake_case)]
#[wasm_bindgen]
pub fn workspaceHistoryStatFolderChildrenById(
    workspace: u32,
    at: f64,
    entry_id: String,
) -> Promise {
    future_to_promise(async move {
        ...
        let ret =
            libparsec::workspace_history_stat_folder_children_by_id(workspace, at, entry_id).await;
        Ok(match ret {
            Ok(value) => {
                let js_obj = Object::new().into();
                Reflect::set(&js_obj, &"ok".into(), &true.into())?;
