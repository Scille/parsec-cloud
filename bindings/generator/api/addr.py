...
class ParseParsecAnyAddrError(ErrorVariant):
    class InvalidUrl:
        pass


class ParsedParsecAnyAddr(Variant):
    class Server:
        hostname: str
        port: U16
...
def parse_parsec_any_addr(url: Ref[str]) -> Result[ParsedParsecAnyAddr, ParseParsecAnyAddrError]:
