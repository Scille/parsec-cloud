...
env.globals.update(
    struct_rs_to_js_function_name=lambda item: f"struct_{pascal_to_snake_case(item.name)}_rs_to_js",
    variant_rs_to_js_function_name=lambda item: f"variant_{pascal_to_snake_case(item.name)}_rs_to_js",
    enum_rs_to_js_function_name=lambda item: f"enum_{pascal_to_snake_case(item.name)}_rs_to_js",
    struct_js_to_rs_function_name=lambda item: f"struct_{pascal_to_snake_case(item.name)}_js_to_rs",
    variant_js_to_rs_function_name=lambda item: f"variant_{pascal_to_snake_case(item.name)}_js_to_rs",
    enum_js_to_rs_function_name=lambda item: f"enum_{pascal_to_snake_case(item.name)}_js_to_rs",
)
