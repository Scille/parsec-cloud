...
msTest.skip('Video viewer', async ({ documents }) => {
  ...
  // // Loop
  // await expect(popoverButtons.nth(2)).not.toHaveClass('file-controls-dropdown-item-active');
  // await popoverButtons.nth(2).click();
  // await expect(popoverButtons.nth(2)).toHaveClass('file-controls-dropdown-item-active');
  // await documents.locator('.ion-backdrop').click();
  // await buttons.nth(0).click();
  // expect(await Media.getPausedState(video)).toBe(false);
  // await documents.waitForTimeout(500);
  // expect(await Media.getPausedState(video)).toBe(false);
  ...
  // await popoverButtons.nth(0).click();
  // await expect(popoverButtons.nth(2)).not.toHaveClass('file-controls-dropdown-item-active');
  // await expect(popoverButtons.nth(0)).toHaveClass('file-controls-dropdown-item-active');
  // await documents.locator('#ion-overlay-4 ion-backdrop').click();
  // await buttons.nth(0).click();
  // await documents.waitForTimeout(2000);
  // await buttons.nth(0).click();
