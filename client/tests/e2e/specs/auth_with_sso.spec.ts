...
// Skip for now because the testbed doesn't return the right openBao configuration on the CI
msTest.skip('Go through custom org creation process, auth SSO', async ({ home }) => {
