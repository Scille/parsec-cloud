...
<template>
  <div class="client-page-processing">
    <template v-if="!querying && !error && customOrderStatus && customOrderStatus !== CustomOrderStatus.Unknown">
      <div class="process-container">
        <div
          ...
          :key="index"
          :class="{
            'process-step-todo': CustomOrderStatusSteps[customOrderStatus] < CustomOrderStatusSteps[step.status],
            'process-step-active': CustomOrderStatusSteps[customOrderStatus] === CustomOrderStatusSteps[step.status],
            'process-step-done': CustomOrderStatusSteps[customOrderStatus] > CustomOrderStatusSteps[step.status],
          }"
        >
          <div class="process-step-icon">
            <div
              class="dot-todo"
              v-if="CustomOrderStatusSteps[customOrderStatus] < CustomOrderStatusSteps[step.status]"
            />
            <div
              class="dot-active"
              v-if="CustomOrderStatusSteps[customOrderStatus] === CustomOrderStatusSteps[step.status]"
    ...
    <template v-else-if="error || customOrderStatus === CustomOrderStatus.Unknown">
