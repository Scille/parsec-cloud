...
<template>
  <ion-page class="modal">
    <ms-modal
      :title="$msTranslate('clientArea.orders.request.title')"
      :subtitle="$msTranslate('clientArea.orders.request.subtitle')"
      :close-button="{ visible: true }"
      :confirm-button="{
        label: $msTranslate('clientArea.orders.request.submit'),
