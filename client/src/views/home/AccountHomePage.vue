        ...
        <div class="homepage-scroll">
          ...
          <div class="homepage-content">
            <ion-menu
              ...
              v-if="windowWidth < 992 || windowHeight < 900"
            >
...
import { chatbubble, chevronForward, close, cog, informationCircle, library, menu, open } from 'ionicons/icons';
import { IonContent, IonPage, IonButton, IonIcon, IonText, IonMenuButton, IonMenu, IonMenuToggle } from '@ionic/vue';
import { ParsecAccount } from '@/parsec';
import { onMounted, ref } from 'vue';
import { openAboutModal } from '@/views/about';
import { Env } from '@/services/environment';
import { LogoIconGradient, MsImage, useWindowSize } from 'megashark-lib';
