    ...
    >
      ...
      >
        <workspace-categories-menu
          :active-menu="getWorkspaceMenu()"
          @update-menu="setWorkspaceMenu"
        />
      </div>
      ...
      <div class="workspaces-container scroll">
        ...
        >
          <div
            ...
            v-if="getWorkspaceMenu() === WorkspaceMenu.All"
          >
            <ms-image
              :image="NoWorkspace"
          ...
          <div
            ...
            v-if="getWorkspaceMenu() === WorkspaceMenu.Recents"
          >
            <ms-image
          ...
          <div
            ...
            v-if="getWorkspaceMenu() === WorkspaceMenu.Favorites"
          >
            <ms-image
