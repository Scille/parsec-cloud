          ...
          >
            ...
            <div v-else>
              ...
              <div v-if="exchangeStartedWith === recipient.userId">
                <ms-spinner class="spinner" /> WAITING FOR THEM TO START THE PROCESS
                <ion-button
                  class="cancel-button"
                  @click="cancelWait"
                >
...
async function onCodeExchangeInterrupted(reason: CodeExchangeInterruptedReason): Promise<void> {
  ...
  switch (reason) {
    case CodeExchangeInterruptedReason.GreeterCancelled: {
      message = 'GREETER CANCELLED';
      break;
    }
    default: {
      message = 'FAILED';
