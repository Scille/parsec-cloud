    ...
    >
      ...
      <div class="invalid-request-text">
        <ion-text class="invalid-request-text__description subtitles-normal">
          {{ $msTranslate(getInvalidReason(request)) }}
        </ion-text>
...
import { InvalidityReasonTag, PkiEnrollmentListItem, PkiEnrollmentListItemInvalid, PkiEnrollmentListItemTag } from '@/parsec';
...
function getInvalidReason(request: PkiEnrollmentListItemInvalid): Translatable {
  switch (request.reason.tag) {
    case InvalidityReasonTag.DateTimeOutOfRange:
      return 'InvitationsPage.pkiRequests.invalidityReasons.expired';
    case InvalidityReasonTag.CannotGetCertificateInfo:
      return 'InvitationsPage.pkiRequests.invalidityReasons.noInfo';
    case InvalidityReasonTag.InvalidRootCertificate:
      return 'InvitationsPage.pkiRequests.invalidityReasons.noRootCertificate';
    case InvalidityReasonTag.Untrusted:
      return 'InvitationsPage.pkiRequests.invalidityReasons.untrusted';
    default:
      return 'InvitationsPage.pkiRequests.invalidityReasons.generic';
  }
}
</script>
