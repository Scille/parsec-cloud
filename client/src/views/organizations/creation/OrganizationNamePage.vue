  ...
  <ion-page class="organization-name-page page-modal-container">
    ...
    <div class="organization-name-page-content">
      <ms-input
        ...
        @on-enter-keyup="!isNextDisabled && $emit('organizationNameChosen', organizationName, sequesterKeyInputRef?.key)"
    ...
    <ion-footer class="organization-name-page-footer">
      ...
      <div class="modal-footer-buttons">
        ...
        <ion-button
          fill="solid"
          size="default"
          @click="$emit('organizationNameChosen', organizationName, sequesterKeyInputRef?.key)"
...
const isNextDisabled = computed(() => {
  ...
  if (sequesterKeyInputRef.value?.isAddKeyToggled && !sequesterKeyInputRef.value?.key) {
    return true;
  }
  return false;
});
