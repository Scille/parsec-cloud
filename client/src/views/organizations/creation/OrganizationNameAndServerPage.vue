    ...
    <ion-footer class="organization-name-and-server-page-footer">
      ...
      <div class="modal-footer-buttons">
        ...
        <ion-button
          ...
          size="default"
          class="button-medium"
          @click="$emit('organizationNameAndServerChosen', organizationName, serverAddr, sequesterKeyInputRef?.key)"
          :disabled="!valid"
        >
          <span>
...
const valid = computed(() => {
  return (
    ...
    (!sequesterKeyInputRef.value?.isAddKeyToggled || (sequesterKeyInputRef.value?.isAddKeyToggled && sequesterKeyInputRef.value?.key))
  );
});
