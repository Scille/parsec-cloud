        ...
        >
          <div class="sidebar-content-organization">
            ...
            <ion-text
              ...
              class="sidebar-content-organization-button button-medium"
              :class="{ active: getWorkspaceMenu() === WorkspaceMenu.All && currentRouteIs(Routes.Workspaces) }"
            ...
            <ion-text
              ...
              :class="{ active: getWorkspaceMenu() === WorkspaceMenu.Recents && currentRouteIs(Routes.Workspaces) }"
              class="sidebar-content-organization-button button-medium"
            ...
            <ion-text
              ...
              :class="{ active: getWorkspaceMenu() === WorkspaceMenu.Favorites && currentRouteIs(Routes.Workspaces) }"
              class="sidebar-content-organization-button button-medium"
...
import { getWorkspaceMenu, setWorkspaceMenu } from '@/services/workspaceMenuState';
