...
import FileOperationConflictsModal from '@/views/files/FileOperationConflictsModal.vue';
...
export { FileContextMenu, FileDetailsModal, FileOperationConflictsModal, FileOperationMenu, FolderGlobalContextMenu, FoldersPage };
