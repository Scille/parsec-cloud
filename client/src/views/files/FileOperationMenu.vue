    ...
    <ion-list class="upload-menu-list">
      ...
      >
        ...
        <ion-text class="body-lg">
          {{ $msTranslate('FoldersPage.ImportFile.noImport') }}
        </ion-text>
      </div>
    </ion-list>
  </div>
...
import { FileOperationData, FileOperationDataType } from '@/services/fileOperation';
...
async function onOperationClick(
  _operation: FileOperationData,
  _status: FileOperationEvents,
