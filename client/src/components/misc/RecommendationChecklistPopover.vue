  ...
  <div class="recommendation-checklist-container">
    ...
    <div class="checklist-list">
      <div
        ...
        :class="{ done: securityWarnings.soloOwnerWorkspaces.length === 0 }"
      ...
      >
        ...
        <ion-icon
          ...
          v-show="securityWarnings.soloOwnerWorkspaces.length > 0"
          :icon="chevronForward"
        />
      </div>
      <div
        class="checklist-list-item subtitles-sm"
        :class="{ done: securityWarnings.hasMultipleDevices }"
      ...
      <div
        class="checklist-list-item subtitles-sm"
        :class="{ done: securityWarnings.hasRecoveryDevice }"
...
import { checkmarkCircle, chevronForward, radio, radioButtonOff } from 'ionicons/icons';
