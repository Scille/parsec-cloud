...
import { FileOperationState, StateData, OperationProgressStateData, DownloadArchiveData } from '@/services/fileOperationManager';
...
defineEmits<{
  ...
  (event: 'click', operationData: DownloadArchiveData, state: FileOperationState): void;
}>();
</script>
