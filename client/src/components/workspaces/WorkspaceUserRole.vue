...
import { getWorkspaceRoleTranslationKeys } from '@/services/translation';
    ...
    [WorkspaceRole.Owner, WorkspaceRole.Manager, WorkspaceRole.Contributor, WorkspaceRole.Reader, null].map(
      (role: WorkspaceRole | null) => {
        return {
          ...
          label: getWorkspaceRoleTranslationKeys(role).label,
          description: getWorkspaceRoleTranslationKeys(role).description,
