...
import AllImportedElementsNotification from '@/components/notifications/AllImportedElementsNotification.vue';
...
export const Notifications = {
  AllImportedElementsNotification,
  DefaultNotification,
  NewDeviceNotification,
  MultipleUsersJoinWorkspaceNotification,
  UserJoinWorkspaceNotification,
