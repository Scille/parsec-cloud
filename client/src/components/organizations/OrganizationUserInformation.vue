    ...
    <div class="card-content">
      ...
      <div class="invitation-card-list">
        <div class="invitation-card-list-item">
          <ion-text class="invitation-card-list-item__number title-h1">{{ invitationsCount }}</ion-text>
        ...
        <div class="invitation-card-list-item">
          <ion-text class="invitation-card-list-item__number title-h1">{{ pkiRequestsCount }}</ion-text>
          <ion-text class="invitation-card-list-item__title button-large">
