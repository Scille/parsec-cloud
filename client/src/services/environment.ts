...
const DISABLE_ACCOUNT_ENV_VARIABLE = 'PARSEC_APP_DISABLE_ACCOUNT';
...
function isAccountDisabled(): boolean {
  return import.meta.env[DISABLE_ACCOUNT_ENV_VARIABLE] === 'true';
}
